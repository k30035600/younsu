' Commission portal — start without showing CMD (Node runs hidden).
' Repo 소스: younsu\web\*.vbs  |  USB: F:\Bundle\ (commission-portal 옆) 또는 F:\ 루트 등.
Option Explicit
...
If Not fso.FileExists(nodeExe) Then
  ' usb_bundle\runtime 경로 (build_bundle_usb_bundle.ps1 구조)
  Dim runtimeNode
